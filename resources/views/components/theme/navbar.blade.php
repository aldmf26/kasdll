                ...
                @php
                    ...
                    $nav = [
                        ...
                        [
                            'nama' => 'Buku Besar',
                            'route' => 'buku_besar',
                            'isi' => ['buku_besar', 'akun', 'jurnal', 'jurnal.add', 'summary_buku_besar.index', 'saldo_awal', 'summary_buku_besar.detail'],
                        ],
                        [
                            'nama' => 'Penjualan',
                            'route' => 'penjualan',
                        ...
                        [
                            ...
                            'isi' => ['persediaan_barang', 'produk', 'opname.index', 'opname.add', 'stok_masuk.index', 'stok_masuk.add'],
                        ],
                    ];
                @endphp
                @foreach ($nav as $d)
